...
- **不要一直用句點**：看起來太嚴肅
- **對話風格參考**：像「那就完美了✨」這種語語
- **糾正後補發**：糾正我之後要當天立刻補發新的題目，不要等到隔天（2026-03-13）
- **科普偏好**：資工專有名詞，詞條 × 簡定義 × 為何重要 × 申論切點；一天上限 3 個，多段行輕鬆風格（2026-03-13）
- **小測驗要開放式問答**：不要先把答案塞在題目下面，也不要做成背答案題型；要讓她能自己申論作答（2026-03-17）
...
- **語氣特徵**：直白承認＋交代處理、先顧影響再講技術、輕鬆不官腔、多段行視覺留白（2026-03-13）
...
- **成大資工二階題型**：30 分鐘、6 題；包含英翻中簡介、科技素養短答、系所課程熟悉度、時事申論（2026-03-13）
...
### 個申書審戰情室 (2026-03-18)
- 整合了 Abigail 提供的新版「書審指引戰情室」HTML 內容，套用極簡白風格，適配手機版並支援 `localStorage` 進度存檔。
- 補回交大電機、交大機械等校系資料與甄試日期連結。
- 更新了交大資工、清大電機、成大電機普渡等 3 份新上傳的 PDF 連結。
- **更新早安提醒腳本**：加入自動判斷早午晚問候語功能。
- **課程登錄**：已登錄 10 門哈佛線上課（化學、物理、數甲）至 Notion 補習課程紀錄。
...
### 個申書審戰情室 (2026-03-18)
- 整合了 Abigail 提供的新版「書審指引戰情室」HTML 內容，並將風格調整為極簡白模式，適配手機版且支援進度存檔 (localStorage)。
- 更新了交大資工、清大電機、成大電機普渡等 PDF 連結。
- 已修正 Checkbox 不獨立的 Bug。
- 補回了交大電機、交大機械等舊有資料與甄試日期。

- **早安腳本更新**：已將 `morning-greeting.mjs` 修改為若在 11:00 後執行會自動切換為「午安」問候語。
